...
@Component({
  selector: 'app-ict-plk-survey',
  templateUrl: './ict-plk-survey.component.html',
  styleUrls: ['./ict-plk-survey.component.css']
})
export class IctPlkSurveyComponent implements OnInit {
