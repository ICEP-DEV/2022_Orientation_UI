...
@Component({
  selector: 'app-economics-plk-survey',
  templateUrl: './economics-plk-survey.component.html',
  styleUrls: ['./economics-plk-survey.component.css']
})
export class EconomicsPlkSurveyComponent implements OnInit {
