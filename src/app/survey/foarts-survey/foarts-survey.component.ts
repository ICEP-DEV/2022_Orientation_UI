...
@Component({
  selector: 'app-foarts-survey',
  templateUrl: './foarts-survey.component.html',
  styleUrls: ['./foarts-survey.component.css']
})
export class FoartsSurveyComponent implements OnInit {
