...
@Component({
  selector: 'app-humanities-plk-survey',
  templateUrl: './humanities-plk-survey.component.html',
  styleUrls: ['./humanities-plk-survey.component.css']
})
export class HumanitiesPlkSurveyComponent implements OnInit {
