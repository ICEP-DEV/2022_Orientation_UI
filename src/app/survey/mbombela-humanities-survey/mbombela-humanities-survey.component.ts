...
@Component({
  selector: 'app-mbombela-humanities-survey',
  templateUrl: './mbombela-humanities-survey.component.html',
  styleUrls: ['./mbombela-humanities-survey.component.css']
})
export class MbombelaHumanitiesSurveyComponent implements OnInit {
