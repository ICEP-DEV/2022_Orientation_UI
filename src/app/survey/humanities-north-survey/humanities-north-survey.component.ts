...
@Component({
  selector: 'app-humanities-north-survey',
  templateUrl: './humanities-north-survey.component.html',
  styleUrls: ['./humanities-north-survey.component.css']
})
export class HumanitiesNorthSurveyComponent implements OnInit {
