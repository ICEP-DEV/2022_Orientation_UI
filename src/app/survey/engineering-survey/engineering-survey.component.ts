...
@Component({
  selector: 'app-engineering-survey',
  templateUrl: './engineering-survey.component.html',
  styleUrls: ['./engineering-survey.component.css']
})
export class EngineeringSurveyComponent implements OnInit {
