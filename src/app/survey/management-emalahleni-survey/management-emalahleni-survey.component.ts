...
@Component({
  selector: 'app-management-emalahleni-survey',
  templateUrl: './management-emalahleni-survey.component.html',
  styleUrls: ['./management-emalahleni-survey.component.css']
})
export class ManagementEmalahleniSurveyComponent implements OnInit {
