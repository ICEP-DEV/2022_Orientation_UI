...
@Component({
  selector: 'app-humanities-survey',
  templateUrl: './humanities-survey.component.html',
  styleUrls: ['./humanities-survey.component.css']
})
export class HumanitiesSurveyComponent implements OnInit {
