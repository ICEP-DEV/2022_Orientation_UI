...
@Component({
  selector: 'app-man-science-plk-survey',
  templateUrl: './man-science-plk-survey.component.html',
  styleUrls: ['./man-science-plk-survey.component.css']
})
export class ManSciencePlkSurveyComponent implements OnInit {
