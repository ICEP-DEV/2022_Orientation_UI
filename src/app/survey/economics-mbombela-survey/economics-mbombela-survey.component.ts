...
@Component({
  selector: 'app-economics-mbombela-survey',
  templateUrl: './economics-mbombela-survey.component.html',
  styleUrls: ['./economics-mbombela-survey.component.css']
})
export class EconomicsMbombelaSurveyComponent implements OnInit {
