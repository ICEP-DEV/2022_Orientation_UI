...
@Component({
  selector: 'app-science-survey',
  templateUrl: './science-survey.component.html',
  styleUrls: ['./science-survey.component.css']
})
export class ScienceSurveyComponent implements OnInit {
