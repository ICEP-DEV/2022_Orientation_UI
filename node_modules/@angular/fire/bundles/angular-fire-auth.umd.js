(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,(global.angular = global.angular || {}, global.angular.fire = global.angular.fire || {}, global.angular.fire.auth = {}), global.ng.core, global.rxjs, global.rxjs.operators, global.angular.fire, global.ng.common));
    ...
    var AngularFireAuth = /** @class */ (function () {
        ...
        tenantId, languageCode, useDeviceLanguage, persistence) {
            ...
            if (common.isPlatformServer(platformId)) {
                 ...
                 */ auth) { return zone.runOutsideAngular(( /**
                 * @return {?}
                 */function () { return new rxjs.Observable(auth.onIdTokenChanged.bind(auth)); })); })), keepUnstableUntilFirst, operators.shareReplay(1) // see authState
                );
                ...
                this.credential = auth.pipe(operators.switchMap(( /**
                 * @param {?} auth
                 * @return {?}
                 */function (/**
                 * @param {?} auth
                 * @return {?}
                 */ auth) { return rxjs.merge(auth.getRedirectResult().then(( /**
                 * @param {?} it
                 * @return {?}
                 */function (/**
                 * @param {?} it
                 ...
                 */ it) { return it; }), ( /**
                 * @return {?}
                 */function () { return null; })), logins, 
                // pipe in null authState to make credential zipable, just a weird devexp if
                // authState and user go null to still have a credential
                _this.authState.pipe(operators.filter(( /**
                 * @param {?} it
                 * @return {?}
                 */function (/**
                 * @param {?} it
                 ...
                 * @param {?} credential
                 * @return {?}
                 */ credential) { return (credential === null || credential === void 0 ? void 0 : credential.user) ? credential : null; })), keepUnstableUntilFirst, operators.shareReplay(1));
            }
